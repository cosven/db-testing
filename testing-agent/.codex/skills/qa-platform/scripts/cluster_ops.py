...
def maybe_fail(ctx: Dict[str, Any], status_code: int, body: str) -> None:
...
def list_clusters(
    ...
    maybe_fail(ctx.obj, status_code, body)
...
def get_cluster(ctx: click.Context, cluster_name: str) -> None:
    ...
    if status:
        ...
        click.echo(body)
    maybe_fail(ctx.obj, status, body)
